...
<br>	
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="Invoice/addNewChallan.php">New Invoice</a></li>
...
<div id="sidebar-menu">
                        ...
                        <ul>
                            ...
                            <li class="has_sub1">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="Stocks/billingstock.php">Billing Stock</a></li>
                                    <li><a href="Stocks/otherstock.php">Other Stock</a></li>             
                                </ul>
                            </li>
                           ...
                           <li class="has_sub1">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="Report/perticulerreport.php">Sell/Purchase Report</a></li>
                ...
                <div class="btn-group" id="mybutton">
                    ...
                    <div style="float: left; margin-top: 10px;">
                        Copyright &copy; <script>document.write(new Date().getFullYear())</script> Ciramic Hub Anand All Rights Reserved                    
                    </div>
