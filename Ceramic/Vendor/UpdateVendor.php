<?php
  $conn2=mysqli_connect('localhost','root','','imsdatabase');
...
<br>
                        <div class="col-12">
                           ...
                           <input type="button" value="Close"  name="close" id="close" class="btn btn-primary" onclick="location.href = './ManageVendor.php';">
                        </div>
                     </form>
                  </div>
               </div>
